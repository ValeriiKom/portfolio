(() => {
    ...
    function initSliders() {
        let thumbsSwiper = new Swiper(".slider-preview-1", {
        ...
        let thumbsSwiper2 = new Swiper(".slider-preview-2", {
            modules: [ Navigation, Thumb, Controller ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        let thumbsSwiper3 = new Swiper(".slider-preview-3", {
            modules: [ Navigation, Thumb, Controller ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        let thumbsSwiper4 = new Swiper(".slider-preview-4", {
            modules: [ Navigation, Thumb, Controller ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        let thumbsSwiper5 = new Swiper(".slider-preview-5", {
            modules: [ Navigation, Thumb, Controller ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        let thumbsSwiper6 = new Swiper(".slider-preview-6", {
            modules: [ Navigation, Thumb, Controller ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        let thumbsSwiper7 = new Swiper(".slider-preview-7", {
            modules: [ Navigation, Thumb, Controller ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
